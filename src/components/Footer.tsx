            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-12 py-20 lg:grid-cols-3 lg:py-24">
              ...
              <div className="flex flex-col">
                ...
                <p className="mt-6 text-sm leading-relaxed text-cream-50/70">
                  Creating elegant, functional and
                  <br />
                  timeless spaces in Dubai.
                </p>
              </div>
              ...
              <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div className="flex flex-col gap-1 sm:flex-row sm:gap-4">
                  <p className="text-xs text-cream-50/40">
                    &copy; Designed by Emerald {new Date().getFullYear()}. All rights reserved.
                  </p>
                  <p className="text-xs text-cream-50/40">
                    Developed by <a href="https://aspireverse.co.uk" target="_blank" rel="noopener noreferrer" className="text-cream-50/60 hover:text-cream-50">AspireVerse™</a>
                  </p>
                </div>
                <Link
                  href="/privacy"
