    ...
    <Container className="mt-16 sm:mt-24 lg:mt-32">
      ...
      >
        <div className="relative z-10">
          <div className="absolute inset-0 bg-marble-deep/80" />
          <div className="relative mx-auto max-w-4xl">
            <div className="max-w-xl">
              <h2 className="font-display text-3xl font-medium text-balance text-cream-50 sm:text-4xl">
                Let us transform your space
              </h2>
              <p className="mt-4 text-base text-cream-50/70">
                Reach out directly to begin your design journey.
              </p>
